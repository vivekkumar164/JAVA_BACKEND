...
CREATE TABLE joined_mentors
(
    user_id BIGINT NOT NULL,
    avg_rating DOUBLE NOT NULL,
    CONSTRAINT pk_joined_mentors PRIMARY KEY (user_id)
);
...
(
    user_id BIGINT NOT NULL,
    psp DOUBLE NOT NULL,
    CONSTRAINT pk_joined_student PRIMARY KEY (user_id)
);
...
ALTER TABLE joined_mentors
    ADD CONSTRAINT FK_JOINED_MENTORS_ON_USER FOREIGN KEY (user_id) REFERENCES joined_user (id);

ALTER TABLE joined_student
    ADD CONSTRAINT FK_JOINED_STUDENT_ON_USER FOREIGN KEY (user_id) REFERENCES joined_user (id);
